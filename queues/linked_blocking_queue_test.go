...
func TestLinkedBlockingQueue_PutAndTake(t *testing.T) {
	...
	time.Sleep(100 * time.Millisecond) // Allow goroutine some time to execute
...
func TestLinkedBlockingQueue_OfferAndPoll(t *testing.T) {
	queue := NewLinkedBlockingQueue[int](2)
...
func TestLinkedBlockingQueue_Dump(t *testing.T) {
